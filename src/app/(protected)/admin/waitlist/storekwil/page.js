...
import FilteredWaitlistTable from "@/components/admin/FilteredWaitlistTable";
import SearchFilters from "@/components/admin/SearchFilters";
import WaitListSearchFilters from "@/components/admin/WaitListSearchFilters";
...
export default async function UsersManagementPage({ searchParams }) {
  ...
  return (
    <>
      ...
      <FilteredWaitlistTable filters={filters}/>
      </Suspense>
    </>
  );
}
