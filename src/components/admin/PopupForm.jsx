...
const PopupForm = ({ title, fields=[],selectInputs=[], onSubmit, onClose,secrets=[],textareas=[] }) => {
        ...
        <form action={formAction}>
...

          {
            selectInputs.map((selectInput)=>(
              ...
              className="border border-gray-300 rounded-md w-full p-2 mb-4 cursor-pointer"
