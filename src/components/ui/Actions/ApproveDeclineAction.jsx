...
import {  approveDelcineDecision } from "@/lib/actions";
const initialState = {
  message: "",
  type: "",
};

const ApproveDeclineAction = ({ caseId }) => {
  const [open, setOpen] = useState(false);
  const [state, formAction] = useFormState(approveDelcineDecision, initialState);
