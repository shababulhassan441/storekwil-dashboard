...
import { createListing, createProduct, updateProduct } from "@/lib/actions";
import Button from "@/components/common/Button";
import { useParams } from "next/navigation";
import { parseCentsToEuros, parsedMinutes } from "@/lib/utils";
...
export default function EditProductForm({ productData }) {
  ...
  const { durationValue, durationType } = parsedMinutes(productData?.duration);
  const { productId, propertyId } = useParams();
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                pattern="[0-9,]*"
                // step="0.01"
                defaultValue={parseCentsToEuros(productData?.price)}
